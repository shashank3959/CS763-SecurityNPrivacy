...
def parser():
    ...
    parser.add_argument('--todo', choices=['train', 'valid', 'test', 'visualize','cw_test'], default='train',
    ...
    parser.add_argument('--cw_attack_modelpath', default='trained_model_shashank/cifar-10_default/checkpoint_76000.pth', help='Path to model file on which you want to test CW Attack')
